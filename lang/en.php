...
$translations = [
    ...
    'um_userform_status' => 'User\'s status
(0 - inactive, 1 - active)',
    'um_userform_pwd' => 'Password',
    'um_userform_folder' => 'User\'s folder'. PHP_EOL .'(leave empty to use default)',
    'um_userform_ullimit' => 'Upload speed limit KB/s, 0 - no speed limit'. PHP_EOL .'(leave empty to use default)',
    'um_userform_dllimit' => 'Download speed limit KB/s, 0 - no speed limit'. PHP_EOL .'(leave empty to use default)',
    'um_userform_permip' => 'Permitted IP-address, * - any IP-address'. PHP_EOL .'(leave empty to use default)',
    'um_userform_quotasize' => 'User quota for uploaded/downloaded data size'. PHP_EOL .'(leave empty to use default)',
    'um_userform_quotafiles' => 'User quota for uploaded/downloaded files'. PHP_EOL .'(leave empty to use default)',
