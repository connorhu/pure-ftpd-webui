				...
				if (($_POST['ftp_dir'] != $ftp_dir) || ($_POST['upload_speed'] != $upload_speed) || ($_POST['download_speed'] != $download_speed) || ($_POST['quota_size'] != $quota_size) || ($_POST['quota_files'] != $quota_files) || ($_POST['permitted_ip'] != $permitted_ip) || ($_POST['pureftpd_conf_path'] != $pureftpd_conf_path) || ($_POST['pureftpd_init_script_path'] != $pureftpd_init_script_path) || ($_POST['pureftpwho_path'] != $pureftpwho_path)) {
					if (isset ($_POST['ftp_dir'])) {
						if ($_POST['ftp_dir'] != $ftp_dir) {
							...
							$result = mysqli_query ($link, "UPDATE settings SET value='$ftp_dir_' WHERE name='ftp_dir'");
							if ($result == 'true') {
					...
					if (isset($_POST['upload_speed'])) {
						if ($_POST['upload_speed'] != $upload_speed) {
							...
							$result = mysqli_query ($link, "UPDATE settings SET value='$upload_speed_' WHERE name='upload_speed'");
							if ($result == 'true') {
					...
					if (isset($_POST['download_speed'])) {
						if ($_POST['download_speed'] != $download_speed) {
							...
							$result = mysqli_query ($link, "UPDATE settings SET value='$download_speed_' WHERE name='download_speed'");
							if ($result == 'true') {
					...
					if (isset($_POST['quota_size'])) {
						if ($_POST['quota_size'] != $quota_size) {
							...
							$result = mysqli_query ($link, "UPDATE settings SET value='$quota_size_' WHERE name='quota_size'");
							if ($result == 'true') {
					...
					if (isset($_POST['quota_files'])) {
						if ($_POST['quota_files'] != $quota_files) {
							...
							$result = mysqli_query ($link, "UPDATE settings SET value='$quota_files_' WHERE name='quota_files'");
							if ($result == 'true') {
					...
					if (isset($_POST['permitted_ip'])) {
						if ($_POST['permitted_ip'] != $permitted_ip) {
							...
							$result = mysqli_query ($link, "UPDATE settings SET value='$permitted_ip_' WHERE name='permitted_ip'");
							if ($result == 'true') {
					...
					if (isset($_POST['pureftpd_conf_path'])) {
						if ($_POST['pureftpd_conf_path'] != $pureftpd_conf_path) {
							...
							$result = mysqli_query ($link, "UPDATE settings SET value='$pureftpd_conf_path_' WHERE name='pureftpd_conf_path'");
							if ($result == 'true') {
					...
					if (isset($_POST['pureftpd_init_script_path'])) {
						if ($_POST['pureftpd_init_script_path'] != $pureftpd_init_script_path) {
							...
							$result = mysqli_query ($link, "UPDATE settings SET value='$pureftpd_init_script_path_' WHERE name='pureftpd_init_script_path'");
							if ($result == 'true') {
					...
					if (isset($_POST['pureftpwho_path'])) {
						if ($_POST['pureftpwho_path'] != $pureftpwho_path) {
							...
							$result = mysqli_query ($link, "UPDATE settings SET value='$pureftpwho_path' WHERE name='pureftpwho_path'");
							if ($result == 'true') {
